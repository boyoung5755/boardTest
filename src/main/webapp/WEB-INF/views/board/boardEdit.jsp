...
<div class="row">
<!-- Form Separator -->
<input type="hidden" value="${detail.fileCode}" id="fileCode" name="fileCode">
  ...
  <div class="card mb-4">
    ...
    <form class="card-body" id="formBoard">
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-9">
          <input value="${detail.boNick }" type="text" id="boNick" name="boNick" class="form-control" >
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-9">
          <input value="**********" id="boPw" name="boPw"   type="password" class="form-control" placeholder="비밀번호를 입력하세요." disabled="disabled">
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-9">
          <input value="${detail.boSj }" type="text" id="boSj" name="boSj" class="form-control" placeholder="제목을 입력하세요.">
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-9">
        	<textarea name="boCn"  id="boCn" rows="5" cols="10" class="form-control">${detail.boCn }"</textarea>
      ...
      <div class="card-body">
	      ...
	      <div class="pt-4">
	        <div class="row justify-content-end">
	          <div class="col-sm-9">
	            <button type="button" class="btn btn-primary me-sm-2 me-1" onclick="fn_updateBoard(${detail.boNo})">수정</button>
